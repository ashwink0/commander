...
cmmndr/1.3.5 darwin-x64 node-v12.16.1
$ cmmndr --help [COMMAND]
USAGE
  $ cmmndr COMMAND
...
...
_See code: [src/commands/add.js](https://github.com/ashwink0/commander/blob/v1.3.5/src/commands/add.js)_
...
_See code: [src/commands/init.js](https://github.com/ashwink0/commander/blob/v1.3.5/src/commands/init.js)_
...
_See code: [src/commands/list.js](https://github.com/ashwink0/commander/blob/v1.3.5/src/commands/list.js)_
...
_See code: [src/commands/remove.js](https://github.com/ashwink0/commander/blob/v1.3.5/src/commands/remove.js)_
...
_See code: [src/commands/run.js](https://github.com/ashwink0/commander/blob/v1.3.5/src/commands/run.js)_
<!-- commandsstop -->
